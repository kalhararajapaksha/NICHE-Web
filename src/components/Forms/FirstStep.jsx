   ...
   /* State={
    ...
    return (
        <div>
            ...
            <div>
            <TextField label="Brand Name" value={userData['brandname']} onChange={(e)=>setUserData({...userData,"brandname":e.target.value})} margin="normal" variant="outlined" color="secondary" />
            </div>
            
            <div>
            <TextField label="Contact No" value={userData['contactno']} onChange={(e)=>setUserData({...userData,"contactno":e.target.value})} margin="normal" variant="outlined" color="secondary" />
            </div>
            <div>
